...
class STM_LMS_User {
	...
	public static function _register_user( $user, $data, $user_email ) {
        ...
        if (!empty($data['user_login']) && !empty($data['user_email'])) {
            ...
            $message .= "\r\n\r\n";
            $message .=  esc_html__('Your registration data:', 'default') . "\r\n\r\n";
            $message .=  esc_html__('User login', 'masterstudy-lms-learning-management-system-pro') . " : " . $data['user_login'] . "\r\n\r\n";
            $message .=  esc_html__('User email', 'masterstudy-lms-learning-management-system-pro') . " : " . $data['user_email'] . "\r\n\r\n";
        }
        ...
        if (!empty($data['additional'])) {
            foreach ($data['additional'] as $field) {
                ...
                $message .= $label . ' : ' . (($field['value'] != '')
                        ? $field['value'] : esc_html__('not filled in', 'default'))
                    . "\r\n\r\n";
            }
        }
